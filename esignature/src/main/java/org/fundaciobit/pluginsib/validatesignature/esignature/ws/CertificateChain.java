...
public class CertificateChain {
    ...
    protected List<CertificateChain.ChainItem> chainItem;
     ...
     * {@link CertificateChain.ChainItem }
     * 
     * 
     */
    public List<CertificateChain.ChainItem> getChainItem() {
        if (chainItem == null) {
            chainItem = new ArrayList<CertificateChain.ChainItem>();
        }

...
public class SimpleReport {
    ...
    protected SimpleReport.Policy policy;
    ...
    protected List<SimpleReport.Signature> signature;
     ...
     * @return
     *     possible object is
     *     {@link SimpleReport.Policy }
     *     
     */
    public SimpleReport.Policy getPolicy() {
        return policy;
    }
     ...
     *     
     */
    public void setPolicy(SimpleReport.Policy value) {
        this.policy = value;
    }
     ...
     * {@link SimpleReport.Signature }
     * 
     * 
     */
    public List<SimpleReport.Signature> getSignature() {
        if (signature == null) {
            signature = new ArrayList<SimpleReport.Signature>();
        }
    ...
    public static class Signature {
        ...
        protected List<SimpleReport.Signature.SignatureScope> signatureScope;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link SimpleReport.Signature.SignatureScope }
         * 
         * 
         */
        public List<SimpleReport.Signature.SignatureScope> getSignatureScope() {
            if (signatureScope == null) {
                signatureScope = new ArrayList<SimpleReport.Signature.SignatureScope>();
            }
